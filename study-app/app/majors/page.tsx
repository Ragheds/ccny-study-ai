    ...
    <main className="min-h-screen bg-black text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <p className="text-gray-500 mb-10">
          {schools.reduce((total, school) => total + school.plans.length, 0)} plans available
        </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {school.plans.map((plan) => (
                <Link
                  ...
                  className="group rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/10 hover:border-blue-500 transition duration-300 hover:-translate-y-1 text-left w-full block"
                >
